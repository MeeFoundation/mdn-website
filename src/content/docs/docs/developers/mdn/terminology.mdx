...
A type of the [claim](#claim). It can be primitive or composite. The details of claim types are to be specified.

## Connection

A special type of [claim](#claim) that declares a data-sharing relationship between a [user](#user) and a [relying party](#relying-party). Always belongs to some [identity context](#identity-context). 
