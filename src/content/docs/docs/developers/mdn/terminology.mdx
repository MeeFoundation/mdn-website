...
An application that allows the user to control their [personal data](#personal-data) and their [identity agent's](#identity-agent) behavior. It could be a [Mee Smartwallet](#mee-smartwallet) or a [Mee website](#mee-website).
