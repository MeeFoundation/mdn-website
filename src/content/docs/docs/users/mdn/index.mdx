...
You can choose to install an MDN-compatible smartwallet that stores attribute values on your mobile or desktop device. This data is never shared with Foundation, and it is only shared with other parties with your explicit consent. 
